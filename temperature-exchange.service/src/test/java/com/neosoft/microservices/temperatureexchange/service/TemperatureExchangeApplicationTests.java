...
class TemperatureExchangeApplicationTests {
	...
	void getExchangeTest() throws Exception{
		MvcResult result = mockMvc.perform(get("/temperature-exchange-test/from/F/to/C").contentType(MediaType.APPLICATION_JSON_VALUE)).andDo(print())
